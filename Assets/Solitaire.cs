...
public class Solitaire : MonoBehaviour
{
    ...
    public void DealFromDeck()
    {
        ...
        if (deckLocation < trips)
        {
            ...
            {
                GameObject newTopCard = Instantiate(cardBack, new Vector3(deckButton.transform.position.x + xOffset, deckButton.transform.position.y, deckButton.transform.position.z + zOffset), Quaternion.identity, deckButton.transform);
